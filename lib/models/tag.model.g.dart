...
Tag _tagDeserialize(
  ...
  object.type = _TagtypeValueEnumMap[reader.readStringOrNull(offsets[1])];
  return object;
}
...
P _tagDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (_TagtypeValueEnumMap[reader.readStringOrNull(offset)]) as P;
    default:
...
const _TagtypeEnumValueMap = {
  ...
  r'cuisine': r'cuisine',
  r'dietaryPreference': r'dietaryPreference',
};
const _TagtypeValueEnumMap = {
  r'mealType': TagType.mealType,
  r'cuisine': TagType.cuisine,
  r'dietaryPreference': TagType.dietaryPreference,
};
