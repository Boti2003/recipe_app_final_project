...
extension RecipeQueryLinks on QueryBuilder<Recipe, Recipe, QFilterCondition> {
  QueryBuilder<Recipe, Recipe, QAfterFilterCondition> tags(FilterQuery<Tag> q) {
    return QueryBuilder.apply(this, (query) {
...
RecipeIngredient _recipeIngredientDeserialize(
  ...
  object.unit =
      _RecipeIngredientunitValueEnumMap[reader.readStringOrNull(offsets[2])];
  return object;
}
...
P _recipeIngredientDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 2:
      return (_RecipeIngredientunitValueEnumMap[
